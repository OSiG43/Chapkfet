<?php
  ...
  //On vérifie que la personne est connectée, sinon on la redirige vers la page de connection
	if(!isset($_SESSION['bucque'])){
		header("Location: ../login.php?p=hints/cannuches"); //Ne pas oublié de changer choucroute pour le nom du fichier.
	}
...
-->
        ...
        <p>La question est : Qui a dormi à la kfet avec 3 cannuches sur la tete ?</p> <!-- Ecrire la question-->
