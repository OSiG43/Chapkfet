<?php
  ...
  //On vérifie que la personne est connectée, sinon on la redirige vers la page de connection
	if(!isset($_SESSION['bucque'])){
		header("Location: ../login.php?p=hints/rakiskz"); //Ne pas oublié de changer choucroute pour le nom du fichier.
	}
...
-->
        ...
        <p>La question est : Qui à vomi à SKZ ?</p> <!-- Ecrire la question-->
