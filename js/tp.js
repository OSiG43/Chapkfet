...
let tp1 = new Tp(1, "Escalier kfet atrium", {x:546,y:2807}, {x:626,y:2886}, 0, 6, 'kfet', {x:0,y:0});
let tp2 = new Tp(2, "Escalier kfet ", {x:1128,y:3452}, {x:1385,y:3670}, 0, 6, 'kfet', {x:0,y:0});
let tp3 = new Tp(3, "Escalier vers 1", {x:1544,y:3171}, {x:1544,y:3171}, 0, 4, 'floor1', {x:0,y:0});
let tp4 = new Tp(4, "Escalier vers 1", {x:1544,y:3171}, {x:1544,y:3171}, 0, 4, 'floor1', {x:0,y:0});
