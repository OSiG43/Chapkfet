...
?>
    ...
    <form method="post">
      ...
      <div class="container">
        ...
        <input type="text" placeholder="Là c'est la Bucque de pek's" name="nom" required>
        <label for="fams"><strong>Fam's</strong></label>
        <input type="text" placeholder="Ton num's de fam's" name="fams" required>
